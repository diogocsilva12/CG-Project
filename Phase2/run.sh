    ...
    case $option in
        ...
        2)
            ...
            4)
                ...
                cd ..
                ;;
            # Update the circle case (option 5)
            5)
                ...
                cd generator
                ./generator circle $radius $segments $filename
                cd ..
                ;;
                
            # Update the torus case (option 6)
            6)
                ...
                cd generator
                ./generator torus $outer_radius $inner_radius $slices $stacks $filename
                cd ..
                ;;
            0)
                continue
